...
11. `17_OpenShift_SCC対応記録_レガシーコード考古学.md`
12. `18_影響分析クエリ設計_レガシーコード考古学.md`
13. `19_デモシナリオ_MVP_レガシーコード考古学.md`
14. `20_MVP完了判定レビュー_レガシーコード考古学.md`
15. `21_文書更新履歴_Phase5_レガシーコード考古学.md`
